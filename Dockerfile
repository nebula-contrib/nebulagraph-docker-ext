...
LABEL org.opencontainers.image.title="NebulaGraph" \
    ...
    com.docker.extension.changelog="Avoid 7001 exposed port, introduce Jupyter extension & ng_ai NetowrkX. See https://github.com/nebula-contrib/nebulagraph-docker-ext/" \
